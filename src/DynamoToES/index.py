...
reserved_fields = [ "uid", "_id", "_type", "_source", "_all", "_parent",
                    "_fieldnames", "_routing", "_index", "_size",
                    "_timestamp", "_ttl" ]
...
def modify_document( es, record ):
  ...
  # doc is large sometimes so we remove the body and internal_state
  clean_doc( doc )
  ...
  print( "Successfully modified - Index: " + table + " - Document ID: " +
         docId )
...
def remove_document( es, record ):
  ...
  print( "Successfully removed - Index: " + table + " - Document ID: " +
         docId )
...
def insert_document( es, record ):
  ...
  print( "Successfully inserted - Index: " + table + " - Document ID: " +
         newId )
